...
export function VehicleStickyCta({ monthlyPayment, vehicleId }: VehicleStickyCtaProps) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-cream/10 bg-charcoal/95 backdrop-blur-2xl backdrop-saturate-150">
      <div className="mx-auto max-w-7xl px-5 py-4 md:px-8 lg:px-12">
        <div className="mb-3 flex items-center justify-between md:hidden">
          <p className="text-xs text-cream-muted">From</p>
