      ...
      <div className="mx-auto max-w-7xl">
        <div className="rounded-[var(--radius-card)] border border-line bg-cream p-5 text-charcoal shadow-lg shadow-black/10 md:p-6">
          <div className="flex items-start justify-between gap-4">
            ...
            <p className="rounded-full bg-green/10 px-3 py-1 text-xs font-medium text-green-deep">
              HP only
            </p>
          </div>
          ...
          <div className="mt-6 space-y-6">
            <div>
              <div className="mb-3 flex items-center justify-between">
                ...
                <span className="text-lg font-medium text-green-deep">{formatPrice(deposit)}</span>
              </div>
              <input
                id="deposit-slider"
                type="range"
                ...
                className="h-2 w-full cursor-pointer appearance-none rounded-full bg-paper/10 accent-coral"
              />
            ...
            <div>
              <div className="mb-3 flex items-center justify-between">
                ...
                <span className="text-lg font-medium text-green-deep">{termMonths} months</span>
              </div>
              <input
                id="term-slider"
                type="range"
