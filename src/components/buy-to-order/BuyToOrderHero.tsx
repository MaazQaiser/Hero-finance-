  ...
  return (
    <section className="relative min-h-[70svh] overflow-hidden md:min-h-[75svh]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[70svh] max-w-7xl flex-col justify-end px-5 pb-16 pt-24 md:min-h-[75svh] md:px-8 md:pb-20 lg:px-12">
        ...
        <h1 className="headline-xl max-w-2xl text-cream">
...
export function BuyToOrderHeader() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-cream/10 bg-charcoal/25 backdrop-blur-2xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8 lg:px-12">
        <Link href="/" className="text-lg font-medium text-cream">
          Hero <span className="font-light text-cream-muted">Car Finance</span>
        </Link>
        <Link href="/cars" className="text-sm text-cream-muted hover:text-cream">
          Browse stock
        </Link>
      </div>
    </header>
