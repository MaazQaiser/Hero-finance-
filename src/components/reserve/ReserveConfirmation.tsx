    ...
    <>
      <header className="border-b border-cream/10 bg-charcoal/25 px-5 py-4 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-lg items-center justify-between">
          <Link
            ...
            className="flex min-h-11 items-center gap-2 text-sm font-medium text-cream hover:text-coral"
          >
            ← Back
          </Link>
          <p className="text-xs uppercase tracking-wide text-cream-muted">Reservation</p>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-lg space-y-6 px-5 py-6 pb-36">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-medium text-cream">Reserve this vehicle</h1>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-cream/10 bg-charcoal/95 backdrop-blur-2xl">
        <div className="mx-auto max-w-lg px-5 py-4">
          <p className="mb-3 text-center text-xs text-cream-muted">
