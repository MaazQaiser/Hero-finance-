...
import { bridgeRotatingMessages } from "@/config/loadingMessages";
  ...
  return (
    <div className="bg-paper">
      <main className="mx-auto flex max-w-lg flex-col justify-center px-5 pb-12 pt-8 text-center md:px-8">
        ...
        <div className="mt-8">
          <div className="mb-4 flex justify-center border-t border-line/80 pt-3">
            <RotatingTrustMessage messages={bridgeRotatingMessages} />
          </div>
          <ApplyPrimaryButton onClick={onContinue} reassurance={journey.bridgeReassurance}>
